...
export interface paths {
    ...
    "/api/v1/forecast": {
        ...
        /**
         * Projected inflow/outflow/net from pending scheduled occurrences, bucketed by period.
    ...
    "/api/v1/recurring-occurrences": {
        ...
        /**
         * List scheduled occurrences, optionally by rule, status, and date range.
         ...
         */
        get: operations["listScheduledOccurrences"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/api/v1/recurring-occurrences/{id}/materialise": {
        ...
        put?: never;
        /**
         * Turn a pending occurrence into a real transaction.
         ...
         */
        post: operations["materialiseOccurrence"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/v1/recurring-occurrences/{id}/skip": {
        ...
        put?: never;
        /**
         * Record that a pending occurrence's firing was deliberately not recorded.
    ...
    "/api/v1/recurring-rules/{id}": {
        ...
        /** Fetch one recurring rule by ID. */
         ...
         */
        delete: operations["archiveRecurringRule"];
        options?: never;
        head?: never;
        /**
         * Update a recurring rule's amount, description, schedule, and end date.
         ...
         */
        patch: operations["patchRecurringRule"];
        trace?: never;
    };
...
export interface components {
    schemas: {
        ...
        CreateRecurringRuleRequest: {
             ...
             */
            amount: string;
            /** @description The category a materialised occurrence would be attributed to, which also decides its direction: an income category makes this an inflow, an expense category an outflow. */
            category_ref: string;
            description: string;
            /**
             * Format: date
        ...
        Forecast: {
            ...
            unconverted?: components["schemas"]["UnconvertedOccurrence"][];
        };
        ForecastEnvelope: {
            data: components["schemas"]["Forecast"];
        };
        ForecastPoint: {
            /** Format: date */
            from: string;
        ...
        MaterialiseOccurrence: {
            occurrence: components["schemas"]["ScheduledOccurrence"];
            transaction: components["schemas"]["Transaction"];
        };
        MaterialiseOccurrenceEnvelope: {
            data: components["schemas"]["MaterialiseOccurrence"];
        };
        NetWorthOverTime: {
            currency: string;
        ...
        RecurringRule: {
            ...
            /**
             * Format: date
             * @description Set only once the rule is archived.
             */
            archived_at?: string;
            category_id: string;
            currency: string;
            ...
            /**
             * Format: date
             * @description Absent when the rule runs indefinitely.
             */
            ends_on?: string;
            id: string;
        ...
        Schedule: {
            /**
             * Format: int32
             * @description 1-31. Set for a monthly or yearly schedule.
             */
            ...
            /**
             * Format: int32
             * @description 1 (January) - 12 (December). Set only for a yearly schedule.
             */
            month?: number | null;
            /**
             * Format: int32
             * @description 0 (Sunday) - 6 (Saturday). Set only for a weekly schedule.
             */
            weekday?: number | null;
        };
        ScheduleRequest: {
        ...
        ScheduledOccurrence: {
            ...
            rule_id: string;
            /** @enum {string} */
            status: "pending" | "materialised" | "skipped";
            /** @description Set only when status is "materialised". */
            transaction_id?: string;
        };
        ScheduledOccurrenceEnvelope: {
            data: components["schemas"]["ScheduledOccurrence"];
        };
        ScheduledOccurrenceListEnvelope: {
            data: components["schemas"]["ScheduledOccurrence"][];
        };
    ...
    responses: {
        /** @description The request would conflict with something that already exists, or with the resource's current state. */
        Conflict: {
            headers: {
                [name: string]: unknown;
            };
...
export interface operations {
    ...
    getForecast: {
        parameters: {
            query?: {
                ...
                to?: string;
                /** @description Convert every figure in the result into this currency. Defaults to your configured reporting currency. */
                currency?: string;
                /** @description Which conversion policy to use. */
                policy?: "transaction_date" | "current" | "pinned";
                /** @description The pinned date to convert at when policy is "pinned". */
                pinned_date?: string;
                /** @description How to bucket/compare periods. Defaults to "month". */
                granularity?: "week" | "month" | "year" | "custom";
            };
        ...
        responses: {
            ...
            200: {
                ...
                content: {
                    "application/json": components["schemas"]["ForecastEnvelope"];
                };
            };
            422: components["responses"]["InvalidInput"];
        };
    ...
    listScheduledOccurrences: {
        ...
        requestBody?: never;
        responses: {
            /** @description Every matching occurrence, ascending by occurrence date. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    materialiseOccurrence: {
        ...
        requestBody?: never;
        responses: {
            /** @description The transaction it produced, and the occurrence's own updated state. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["MaterialiseOccurrenceEnvelope"];
                };
            };
            404: components["responses"]["NotFound"];
    ...
    skipOccurrence: {
        ...
        requestBody?: never;
        responses: {
            /** @description The occurrence's own updated state. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
                content: {
                    "application/json": components["schemas"]["ScheduledOccurrenceEnvelope"];
                };
            };
            404: components["responses"]["NotFound"];
            409: components["responses"]["Conflict"];
    ...
    listRecurringRules: {
        ...
        requestBody?: never;
        responses: {
            /** @description Every recurring rule, most recently created first. */
            200: {
                headers: {
                    [name: string]: unknown;
                };
    ...
    patchRecurringRule: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["PatchRecurringRuleRequest"];
            };
        };
        responses: {
